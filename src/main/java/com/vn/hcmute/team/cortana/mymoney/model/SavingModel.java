...
public class SavingModel {
    ...
    public void createSaving(String userid, String token, Saving saving,
    ...
    public void updateSaving(String userid, String token, Saving saving,
              CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
    ...
    public void deleteSaving(String userid, String token, String idSaving,
              CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
    ...
    public void takeIn(String userid, String token, String idWallet, String idSaving,
              String moneyUpdateWallet,
              String moneyUpdateSaving, CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
    ...
    public void takeOut(String userid, String token, String idWallet, String idSaving,
              String moneyUpdateWallet,
              String moneyUpdateSaving, CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
    ...
    public void syncSaving(List<Saving> list, String userid, String token,
              CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
