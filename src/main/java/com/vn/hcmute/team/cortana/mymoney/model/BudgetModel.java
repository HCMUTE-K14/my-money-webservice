...
public class BudgetModel {
	...
	public void createBudget(Budget budget,String userid, String token, CallBack<String> callBack) {
		try{
			if(TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)){
	...
	public void updateBudget(Budget budget,String userid, String token, CallBack<String> callBack) {
		try{
	...
	public void deleteBudget(String userid, String token, String budgetId, CallBack<String> callBack) {
		try{
			if(TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)){
