...
public class TransactionController {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String getByType_wallet(@QueryParam("uid") String userid,
        ...
        mTransactionModel
                  .getTransactionByType(userid, token, Integer.valueOf(type), walletid, callBack);
        return response.toString();
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String getByTime_wallet(@QueryParam("uid") String userid,
              @QueryParam("token") String token,
              @QueryParam("startdate") String startDate, @QueryParam("enddate") String endDate,
        ...
        mTransactionModel
                  .getTransactionByTime(userid, token, startDate, endDate, walletId, callBack);
        return response.toString();
    }
    ...
    public String getByCategory(@QueryParam("uid") String userid, @QueryParam("token") String token,
        ...
        mTransactionModel.getTransactionByCategory(userid, token, categoryId, startDate, endDate,
                  callBack);
        return response.toString();
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String getByCategory_wallet(@QueryParam("uid") String userid,
              @QueryParam("token") String token,
        ...
        mTransactionModel
                  .getTransactionByCategory(userid, token, categoryId, startDate, endDate, walletId,
                            callBack);
        return response.toString();
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String getTransactionByEvent(@QueryParam("uid") String userid,
              @QueryParam("token") String token,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String getTransactionByBudget(@QueryParam("uid") String userid,
              @QueryParam("token") String token,
              @PathParam("startDate") String startDate, @PathParam("endDate") String endDate,
              @PathParam("categoryId") String categoryId, @PathParam("walletId") String walletId) {
        Class<List<Transaction>> clazz = (Class<List<Transaction>>) (Object) List.class;
        ...
        mTransactionModel
                  .getTransactionByBudget(userid, token, startDate, endDate, categoryId, walletId,
                            callBack);
        return response.toString();
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String getTransactionBySaving(@QueryParam("uid") String userid,
              @QueryParam("token") String token,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public String sync(@QueryParam("uid") String userid, @QueryParam("token") String token,
