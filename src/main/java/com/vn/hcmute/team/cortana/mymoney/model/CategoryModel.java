...
public class CategoryModel {
    ...
    public void getCategoryByUserId(String userid, String token,
    ...
    public void getCategoryByTransactionType(String userid, String token, String transactionType,
              CallBack<List<Category>> callback) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
                callback.onFailure(new UserException("User id, token is empty"));
            ...
            List<Category> result = mDataRepository
                      .getCategoryByTransactionType(userid, transactionType);
    ...
    public void getCategoryByType(String userid, String token, String type, String transType,
              CallBack<List<Category>> callback) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
                callback.onFailure(new UserException("User id, token is empty"));
    ...
    public void addCategory(String userid, String token, Category category, String parentId,
        ...
        try {
            ...
            if (!category.getUser_id().equals(userid)) {
                callback.onFailure(
                          new CategoryException("Category userid have different userid param"));
                return;
            }
    ...
    public void updateCategory(String userid, String token, Category category, String oldParentId,
              String newParentId,
              CallBack<String> callback) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
    ...
    public void removeCategory(String userid, String token, Category category, String parentId,
              CallBack<String> callback) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
                callback.onFailure(new UserException("User id, token is empty"));
