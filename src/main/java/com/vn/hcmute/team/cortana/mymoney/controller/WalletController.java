...
public class WalletController {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String create(Wallet wallet, @PathParam("userid") String userid,
    ...
    @Consumes(MediaType.APPLICATION_JSON + UTF8)
    @Produces(MediaType.APPLICATION_JSON + UTF8)
    public String getWalletById(@QueryParam("uid") String userid, @QueryParam("token") String token,
    ...
    public String delete(@PathParam("userid") String userid, @PathParam("token") String token,
              @PathParam("idwallet") String idwallet) {
        JsonResponse<String> response = new JsonResponse<String>(String.class);
        CallBack<String> callBack = new CallBack<String>() {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String update(Wallet wallet, @PathParam("userid") String userid,
              @PathParam("token") String token) {
        JsonResponse<String> response = new JsonResponse<String>(String.class);
        CallBack<String> callBack = new CallBack<String>() {
    ...
    public String move(@QueryParam("uid") String userid, @QueryParam("token") String token,
              @QueryParam("wallet_from") String walletFrom,
              @QueryParam("wallet_to") String walletTo,
        ...
        walletModel.moveMoneyWallet(userid, token, walletFrom, walletTo, moneyMinus, moneyPlus,
                  date_created, callBack);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String update(List<Wallet> list, @PathParam("userid") String userid,
              @PathParam("token") String token) {
        JsonResponse<String> response = new JsonResponse<String>(String.class);
        CallBack<String> callBack = new CallBack<String>() {
