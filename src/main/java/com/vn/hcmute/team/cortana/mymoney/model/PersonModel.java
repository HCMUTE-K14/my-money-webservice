...
public class PersonModel {
    ...
    public void updatePerson(String userid, String token, Person person,
    ...
    public void synchPerson(String userid, String token, List<Person> persons,
              CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
                callBack.onFailure(new Throwable("Fail update Person!"));
    ...
    public void removePerson(String userid, String token, String personid,
              CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
