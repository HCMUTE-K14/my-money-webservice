...
public class DebtLoanController {
	...
	public String get(@QueryParam("uid") String userid, @QueryParam("token") String token,
			@QueryParam("wallet_id") String wallet_id,@DefaultValue("all") @QueryParam("type") String type) {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public String add(@QueryParam("uid") String userId, @QueryParam("token") String token, DebtLoan debtLoan) {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public String delete(@QueryParam("uid") String userId, @QueryParam("token") String token, DebtLoan debtLoan) {
		JsonResponse<String> response = new JsonResponse<String>(String.class);
		CallBack<String> callback = new CallBack<String>() {
