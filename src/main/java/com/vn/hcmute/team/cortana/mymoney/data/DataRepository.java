...
public class DataRepository implements DataSource.UserDataSource, DataSource.CurrenciesDataSource,
                                       DataSource.EventDataSource, DataSource.CategorySource,
                                       DataSource.WalletDataSource, DataSource.SavingDataSource,
                                       DataSource.PersonDataSource, DataSource.ImageDataSource,
                                       DataSource.TransactionDataSource,
                                       DataSource.BudgetDataSource, DataSource.DebtLoanSource {
    ...
    @Override
    public void moveMoneyWallet(String userid, String wallet_id_from, String wallet_id_to,
              String moneyMinus,
              String moneyPlus, String date_created) {
        mWalletService.moveMoneyWallet(userid, wallet_id_from, wallet_id_to, moneyMinus, moneyPlus,
                  date_created);
    }
    ...
    @Override
    public List<Image> uploadImage(String userid, String token, String detail,
              InputStream[] input) {
    ...
    public List<Transaction> getTransactionByCategory(String categoryId, String userid,
        ...
        return mTransactionService
                  .getTransactionByCategory(categoryId, userid, startDate, endDate, walletId);
    }
    ...
    public List<Transaction> getTransactionByBudget(String userId, String startDate, String endDate,
              ...
              String walletId) {
        return mTransactionService
                  .getTransactionByBudget(userId, startDate, endDate, categoryId, walletId);
    }
