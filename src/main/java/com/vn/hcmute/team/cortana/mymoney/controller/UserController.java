...
public class UserController {
	...
	@Path("changepassword")
	@Produces(MediaType.APPLICATION_JSON)
	public String changepassword(@QueryParam("uid") String userid, @QueryParam("token") String token,
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public String changeprofile(@QueryParam("uid") String userid, @QueryParam("token") String token, User user) {
