...
public class DebtLoanModel {
    ...
    public void getListDebtLoan(String userid, String token, String wallet_id,
              CallBack<List<DebtLoan>> callBack) {
        try {
    ...
    public void addDebtLoan(String userid, String token, DebtLoan debtLoan,
    ...
    public void updateDebtLoan(String userid, String token, String wallet_id, DebtLoan debtLoan,
              CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
                callBack.onFailure(new Throwable("Fail get person!"));
    ...
    public void deleteDebtLoan(String userid, String token, DebtLoan debtLoan,
              CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
                callBack.onFailure(new Throwable("Fail get person!"));
    ...
    public void getDebtLoanByType(String userid, String token, String wallet_id, String type,
              CallBack<List<DebtLoan>> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token)) {
                callBack.onFailure(new Throwable("Fail get person!"));
