...
public class BudgetController {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String createBudget(Budget budget, @QueryParam("userid") String userid,
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String updateBudget(Budget budget, @QueryParam("userid") String userid,
              @QueryParam("token") String token) {
        JsonResponse<String> response = new JsonResponse<String>(String.class);
        CallBack<String> callBack = new CallBack<String>() {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String deleteBudget(@QueryParam("userid") String userid,
              @QueryParam("token") String token,
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String syncBudget(List<Budget> list, @QueryParam("userid") String userid,
              @QueryParam("token") String token) {
        JsonResponse<String> response = new JsonResponse<String>(String.class);
        CallBack<String> callBack = new CallBack<String>() {
