...
public class UserModel {
    ...
    public void changePassword(String userid, String token, String oldpassword, String newpassword,
              CallBack<String> callBack) {
        try {
            if (TextUtil.isEmpty(userid) || TextUtil.isEmpty(token) || TextUtil.isEmpty(oldpassword)
                || TextUtil.isEmpty(newpassword)) {
                callBack.onFailure(
                          new UserException("Userid,token,oldpassword or newpassword is empty"));
                return;
            }
