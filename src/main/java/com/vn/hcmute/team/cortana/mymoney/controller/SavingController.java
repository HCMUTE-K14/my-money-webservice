...
public class SavingController {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String create(Saving saving, @PathParam("userid") String userid,
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String update(Saving saving, @PathParam("userid") String userid,
              @PathParam("token") String token) {
        JsonResponse<String> response = new JsonResponse<String>(String.class);
    ...
    public String takeIn(@PathParam("userid") String userid, @PathParam("token") String token,
        ...
        savingModel.takeIn(userid, token, idWallet, idSaving, moneyUpdateWallet, moneyUpdateSaving,
                  callBack);
        return response.toString();
    }
    ...
    public String takeOut(@PathParam("userid") String userid, @PathParam("token") String token,
        ...
        savingModel.takeOut(userid, token, idWallet, idSaving, moneyUpdateWallet, moneyUpdateSaving,
                  callBack);
        return response.toString();
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String syncSaving(List<Saving> list, @PathParam("userid") String userid,
              @PathParam("token") String token) {
        JsonResponse<String> response = new JsonResponse<String>(String.class);
        CallBack<String> callBack = new CallBack<String>() {
